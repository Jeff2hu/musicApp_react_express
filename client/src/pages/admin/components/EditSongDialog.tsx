...
const EditSongDialog = ({
  ...
  function createSongSuccess() {
    ...
    toast.success(t("ADMIN.SUCCESSFULLY_CREATED_THE_SONG"));
      ...
      >
        ...
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">
            {mode === "add" ? t("ADMIN.ADD_NEW_SONG") : t("ADMIN.UPDATE_SONG")}
          </DialogTitle>
          <DialogDescription className="text-zinc-400">
            {mode === "add"
              ? t("ADMIN.ADD_NEW_SONG_TO_YOUR_LIBRARY")
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
              ...
              >
                {audioFile ? (
                  ...
                  <p className="text-sm text-zinc-400 p-2 text-center">
                    {t("SONG.PLEASE_UPLOAD_AUDIO_FILE")}
                  </p>
                )}
              </div>
              <Button
          ...
          <InputField
            ...
            errors={errors}
            inputProps={{
              placeholder: t("SONG.ENTER_THE_SONG_TITLE"),
            }}
          />
          ...
          <InputField
            ...
            errors={errors}
            inputProps={{
              placeholder: t("SONG.ENTER_THE_ARTIST_NAME"),
            }}
          />
          ...
          <InputField
            ...
            errors={errors}
            inputProps={{
              placeholder: t("SONG.ENTER_THE_DURATION"),
              type: "number",
            }}
          />
